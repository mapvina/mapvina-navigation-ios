# Contributing to the Mapvina Navigation SDK for iOS
...
Before reporting a bug here, please determine whether the issue lies with the navigation SDK itself or with another Mapvina/Mapbox product:
...
You can run tests locally in Xcode. As a safety measure tests are run via GitHub Actions when you submitt a PR. If you are a first time contributor a member of mapvina needs to approve the GitHub Actions runs first, for this please tag someone either in GitHub or in the OpenStreetMap Slack.
