...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/mapvina/mapvina-gl-native-distribution.git", from: "6.0.0"),
    ...
    targets: [
        ...
        .testTarget(
            ...
            resources: [
                ...
                //	CodeSign ~/Library/Developer/Xcode/DerivedData/mapvina-navigation-ios-cdijqyqwjamndzfaqhxchbiayzsb/Build/Products/Debug-iphonesimulator/mapvina-navigation-ios_MapboxNavigationTests.bundle  (in target 'mapvina-navigation-ios_MapboxNavigationTests' from project 'mapvina-navigation-ios')
                //	cd ~/Developer/mapvina-navigation-ios
                //
                //	Signing Identity:     "-"
                //
                //	/usr/bin/codesign --force --sign - --timestamp\=none --generate-entitlement-der ~/Library/Developer/Xcode/DerivedData/mapvina-navigation-ios-cdijqyqwjamndzfaqhxchbiayzsb/Build/Products/Debug-iphonesimulator/mapvina-navigation-ios_MapboxNavigationTests.bundle
                //
                //	~/Library/Developer/Xcode/DerivedData/mapvina-navigation-ios-cdijqyqwjamndzfaqhxchbiayzsb/Build/Products/Debug-iphonesimulator/mapvina-navigation-ios_MapboxNavigationTests.bundle: bundle format unrecognized, invalid, or unsuitable
