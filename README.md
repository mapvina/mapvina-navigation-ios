...
1. Mapbox decided to put a closed source component to their navigation SDK and introduced a non open source license. Mapvina wants an open source solution.
...
MapvinaNavigation version 4 allows you to start a navigation in an existing Map, so no modal ViewController needs to be presented over an existing map as before. This results in some breaking changes. 
...
Copyright (c) 2022 MapVina contributors
